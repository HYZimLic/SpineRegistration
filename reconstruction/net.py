...
class ReconNet(nn.Module):
	...
	def __init__(self, in_channels, out_channels, gain=0.02, init_type='standard'):
		...
		self.conv_layer1 = _make_layers(in_channels, 	64, 	'conv4_s2', False)
		self.conv_layer2 = _make_layers(64, 		64, 	'conv3_s1', '2d')
		self.relu2 = nn.ReLU(inplace=True)
		self.conv_layer3 = _make_layers(64,			128,	'conv4_s2', '2d', 'relu')
		self.conv_layer4 = _make_layers(128,		128,	'conv3_s1', '2d')
		self.relu4 = nn.ReLU(inplace=True)
		self.conv_layer5 = _make_layers(128,		256, 'conv4_s2', '2d', 'relu')
		self.conv_layer6 = _make_layers(256,		256, 'conv3_s1', '2d')
		self.relu6 = nn.ReLU(inplace=True)
		self.conv_layer7 = _make_layers(256, 		512, 	'conv4_s2', '2d', 'relu')
		self.conv_layer8 = _make_layers(512, 		512, 	'conv3_s1', '2d')
		self.relu8 = nn.ReLU(inplace=True)
		self.conv_layer9 = _make_layers(512, 		1024, 	'conv4_s2', '2d', 'relu')
		self.conv_layer10 = _make_layers(1024, 		1024, 	'conv3_s1', '2d')
		self.relu10 = nn.ReLU(inplace=True)
		self.conv_layer11 = _make_layers(1024, 		2048, 	'conv4_s2', '2d', 'relu')
		self.conv_layer12 = _make_layers(2048, 		2048, 	'conv3_s1', '2d')
		self.relu12 = nn.ReLU(inplace=True)
		self.conv_layer13 = _make_layers(2048, 		4096, 	'conv4_s2', '2d', 'relu')
		self.conv_layer14 = _make_layers(4096, 		4096, 	'conv3_s1', '2d')
		...
		self.deconv_layer11 = _make_layers(2048, 	1024, 	'deconv4x4_s2', '3d', 'relu')
		self.deconv_layer10 = _make_layers(1024,	512, 	'deconv4x4_s2', '3d', 'relu')
		self.deconv_layer9 = _make_layers(512,		512, 	'deconv3x3_s1', '3d', 'relu')
		self.deconv_layer8 = _make_layers(512,		256, 	'deconv4x4_s2', '3d', 'relu')
		self.deconv_layer7 = _make_layers(256,		256, 	'deconv3x3_s1', '3d', 'relu')
		self.deconv_layer6 = _make_layers(256,		128, 	'deconv4x4_s2', '3d', 'relu')
		self.deconv_layer5 = _make_layers(128,		128, 	'deconv3x3_s1', '3d', 'relu')
		self.deconv_layer4 = _make_layers(128,		64, 	'deconv4x4_s2', '3d', 'relu')
		self.deconv_layer3 = _make_layers(64,		64,		'deconv3x3_s1', '3d', 'relu')
		self.deconv_layer2 = _make_layers(64,		32,		'deconv4x4_s2', '3d', 'relu')
		self.deconv_layer1 = _make_layers(32,		32,		'deconv3x3_s1', '3d', 'relu')
		self.deconv_layer0 = _make_layers(32,		1, 		'conv1x1_s1', False, 'relu')
		self.deconv_layer00 = _make_layers(128, 1, 'conv1x1_s1', False, 'relu')
		self.output_layer = _make_layers(32,	out_channels, 'conv1_s1', False)
		self.output_layer00 = _make_layers(128, out_channels, 'conv1_s1', False)
	...
	def forward(self, x, out_feature=False):
		...
		conv11 = self.conv_layer11(relu10)
		conv12 = self.conv_layer12(conv11)
		relu12 = self.relu12(conv11 + conv12)
		conv13 = self.conv_layer13(relu12)
		conv14 = self.conv_layer14(conv13)
		relu14 = self.relu10(conv13 + conv14)
		### transform module
		...
		### generation network
		deconv11 = self.deconv_layer11(trans_features)
		deconv10 = self.deconv_layer8(deconv11)
		deconv9 = self.deconv_layer7(deconv10)
		deconv8 = self.deconv_layer6(deconv9)
		...
		middle = self.deconv_layer00(deconv5)
		middle = torch.squeeze(middle, 1)
		middle = self.output_layer(middle)
		### output
