...
def val(model, val_loader, loss_func, n_labels):
    ...
    #if n_labels==26: val_log.update({'Val_dice_1': val_dice.avg[1], 'Val_dice_2': val_dice.avg[2], 'Val_dice_3': val_dice.avg[3], 'Val_dice_4': val_dice.avg[4]})
    return val_log
...
def train(model, train_loader, optimizer, loss_func, n_labels, alpha):
    ...
    val_log = OrderedDict({'Train_Loss': train_loss.avg})
    # if n_labels==26: val_log.update({'Train_dice_tumor': train_dice.avg[2]})
    return val_log
